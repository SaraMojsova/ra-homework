...
// THIS IS SOMETHING I TRIED AS A FIRST IDEA BUT DIDN'T SUCCEED

// function passwordCharLength(input){
    //     // const charLengthRegex=/^(?=.{7,20}$).*/;
    //     // const charLengthRegex= /^\w{5,10}$/;
    //     const passwordLength=input.value.trim().length
    ...
    //   function emailCharLength(input){
    //     // const charLengthRegex=/^{,320}$/;
    //     const emailValue=input.value.trim().length
    //     if(emailValue>320){
    //         return showError(input, 'Email limit is 320 characters')
    //     }
    //     return true;
    //   }